...
namespace Fodinae.UI
{
    ...
    ///
    /// Дизайн-система (visual/main-menu-mirror) описывает три тира: compact,
    ...
    public static class UiLayoutTier
    {
        ...
        public static void Apply(VisualElement root)
        {
            ...
            Debug.Log(
                $"[Тир] {tier}: панель {width:F0}×{root.resolvedStyle.height:F0} лог. px, " +
                $"экран {Screen.width}×{Screen.height} физ. px, dpi {Screen.dpi:F0}, " +
                $"диагональ {ScreenDiagonalInches():F1}\"");
#endif
        }
