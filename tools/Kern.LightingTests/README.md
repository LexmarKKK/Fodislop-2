...
dotnet run --project tools/Kern.LightingTests/Kern.LightingTests.csproj -- equivalence reference.compute candidate.compute
dotnet run --project tools/Kern.LightingTests/Kern.LightingTests.csproj -- compile
dotnet run --project tools/Kern.LightingTests/Kern.LightingTests.csproj -- streaming
dotnet run --project tools/Kern.LightingTests/Kern.LightingTests.csproj -- freeze-report LightingDumps/<dump>
```
